...
use crate_::std_ops::{AddMt, MulMt, SubOp, SubRevMt};

use crate_::collection_ops::*;
use crate_::field_traits::{GetField, SetField};
use crate_::ops::{
    Add1Op, Add1Op as AddOne, AssertEq, AssertPipedRet, ConstEqMt, ConstFrom, ConstGEOp, ConstInto,
    ConstIntoMt, ConstLtMt, ConstNEMt, SafeDivOp, SafeSubOp, SatSub1,
};
...
fn try_fold_l() {
    ...
    let _: TestTryFoldL<tlist![U5, ()], U4, safe_sub, TFBreak<Err_<CannotSubstract<U4, U5>>>>;
}
...
fn try_fold_r() {
    ...
    let _: TestTryFoldR<tlist![(), U5], U4, safe_sub, TFBreak<Err_<CannotSubstract<U4, U5>>>>;
    let _: TestTryFoldR<
        tlist![(), U5, U1],
        U4,
        safe_sub,
...
fn map() {
    ...
    let _: TestMap<Repeat<TListType, True, U64>, Const<False>, Repeat<TListType, False, U64>>;
}
...
fn flatten() {
    ...
    let _: Test<tlist![Some_<U0>, None_, Some_<U2>, (U3, U4, U5)], tlist![U0, U2, U3, U4, U5]>;
}
...
fn repeat() {
    ...
    let _: AssertEq<Map<Repeat<TListType, U0, U100>, Const<()>>, Repeat<TListType, (), U100>>;
}
