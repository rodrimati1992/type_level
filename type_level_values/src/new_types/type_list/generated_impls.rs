...
use crate_::ops::{
    Filter_, FoldL_,FoldR_,TypeFn_, Map_,
};
...
impl<L0,OrRes0,DefaultVal,Op,> FoldL_<DefaultVal,Op,>
for tlist![L0,]
where
...
impl<L0,OrRes0,L1,OrRes1,DefaultVal,Op,> FoldL_<DefaultVal,Op,>
for tlist![L0,L1,]
where
	Op:TypeFn_<(DefaultVal,L0),Output=OrRes0>,
...
impl<L0,OrRes0,L1,OrRes1,L2,OrRes2,L3,OrRes3,L4,OrRes4,DefaultVal,Op,> FoldL_<DefaultVal,Op,>
...
impl<L0,OrRes0,L1,OrRes1,L2,OrRes2,L3,OrRes3,L4,OrRes4,L5,OrRes5,DefaultVal,Op,> FoldL_<DefaultVal,Op,>
...
impl<L0,OrRes0,L1,OrRes1,L2,OrRes2,L3,OrRes3,L4,OrRes4,L5,OrRes5,L6,OrRes6,DefaultVal,Op,> FoldL_<DefaultVal,Op,>
...
impl<L0,OrRes0,L1,OrRes1,L2,OrRes2,L3,OrRes3,L4,OrRes4,L5,OrRes5,L6,OrRes6,L7,OrRes7,OrRes8,Rem,DefaultVal,Op,> FoldL_<DefaultVal,Op,>
...
impl<L0,OrRes0,L1,OrRes1,DefaultVal,Op,>
	FoldR_<DefaultVal,Op,>
for tlist![L0,L1,]
where
...
impl<L0,OrRes0,L1,OrRes1,L2,OrRes2,DefaultVal,Op,>
	FoldR_<DefaultVal,Op,>
for tlist![L0,L1,L2,]
where
...
impl<L0,OrRes0,L1,OrRes1,L2,OrRes2,L3,OrRes3,DefaultVal,Op,>
	FoldR_<DefaultVal,Op,>
for tlist![L0,L1,L2,L3,]
where
...
impl<L0,OrRes0,L1,OrRes1,L2,OrRes2,L3,OrRes3,L4,OrRes4,L5,OrRes5,L6,OrRes6,DefaultVal,Op,>
	FoldR_<DefaultVal,Op,>
for tlist![L0,L1,L2,L3,L4,L5,L6,]
where
...
impl<L0,OrRes0,L1,OrRes1,L2,OrRes2,L3,OrRes3,L4,OrRes4,L5,OrRes5,L6,OrRes6,L7,OrRes7,OrRes8,Rem,DefaultVal,Op,>
	FoldR_<DefaultVal,Op,>
for tlist![L0,L1,L2,L3,L4,L5,L6,L7,..Rem]
where
...
impl<L0,OrRes0,L1,OrRes1,L2,OrRes2,Op>
	Map_<Op>
for tlist![L0,L1,L2,]
where
	Op:TypeFn_<L0,Output=OrRes0>,
...
impl<L0,OrRes0,L1,OrRes1,L2,OrRes2,L3,OrRes3,Op>
	Map_<Op>
for tlist![L0,L1,L2,L3,]
where
	Op:TypeFn_<L0,Output=OrRes0>,
...
impl<L0,OrRes0,L1,OrRes1,L2,OrRes2,L3,OrRes3,L4,OrRes4,Op>
	Map_<Op>
for tlist![L0,L1,L2,L3,L4,]
where
	Op:TypeFn_<L0,Output=OrRes0>,
...
impl<L0,OrRes0,L1,OrRes1,L2,OrRes2,L3,OrRes3,L4,OrRes4,L5,OrRes5,Op>
	Map_<Op>
for tlist![L0,L1,L2,L3,L4,L5,]
where
	Op:TypeFn_<L0,Output=OrRes0>,
...
impl<L0,OrRes0,L1,OrRes1,L2,OrRes2,L3,OrRes3,L4,OrRes4,L5,OrRes5,L6,OrRes6,L7,OrRes7,Rem,RemOut,Op>
	Map_<Op>
for tlist![L0,L1,L2,L3,L4,L5,L6,L7,..Rem]
where
	Op:TypeFn_<L0,Output=OrRes0>,
...
{
	type Output=tlist![OrRes0,OrRes1,OrRes2,OrRes3,OrRes4,OrRes5,OrRes6,OrRes7,..RemOut];
}
