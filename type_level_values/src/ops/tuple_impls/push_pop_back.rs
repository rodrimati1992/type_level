...
impl<L0> PopBack_ for (L0,) {
    type Output = Some_<(L0, ())>;
}

impl<L0, L1> PopBack_ for (L0, L1) {
    type Output = Some_<(L1, (L0,))>;
}

impl<L0, L1, L2> PopBack_ for (L0, L1, L2) {
    type Output = Some_<(L2, (L0, L1))>;
}

impl<L0, L1, L2, L3> PopBack_ for (L0, L1, L2, L3) {
    type Output = Some_<(L3, (L0, L1, L2))>;
}

impl<L0, L1, L2, L3, L4> PopBack_ for (L0, L1, L2, L3, L4) {
    type Output = Some_<(L4, (L0, L1, L2, L3))>;
}

impl<L0, L1, L2, L3, L4, L5> PopBack_ for (L0, L1, L2, L3, L4, L5) {
    type Output = Some_<(L5, (L0, L1, L2, L3, L4))>;
}

impl<L0, L1, L2, L3, L4, L5, L6> PopBack_ for (L0, L1, L2, L3, L4, L5, L6) {
    type Output = Some_<(L6, (L0, L1, L2, L3, L4, L5))>;
}

impl<L0, L1, L2, L3, L4, L5, L6, L7> PopBack_ for (L0, L1, L2, L3, L4, L5, L6, L7) {
    type Output = Some_<(L7, (L0, L1, L2, L3, L4, L5, L6))>;
}

impl<L0, L1, L2, L3, L4, L5, L6, L7, L8> PopBack_ for (L0, L1, L2, L3, L4, L5, L6, L7, L8) {
    type Output = Some_<(L8, (L0, L1, L2, L3, L4, L5, L6, L7))>;
}

impl<L0, L1, L2, L3, L4, L5, L6, L7, L8, L9> PopBack_ for (L0, L1, L2, L3, L4, L5, L6, L7, L8, L9) {
