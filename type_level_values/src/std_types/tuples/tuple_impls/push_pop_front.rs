use crate_::collection_ops::{PopFront_, PushFront_};
use prelude::*;

impl<Value> PushFront_<Value> for () {
    type Output = (Value,);
}

impl<L0, Value> PushFront_<Value> for (L0,) {
    type Output = (Value, L0);
}

impl<L0, L1, Value> PushFront_<Value> for (L0, L1) {
    type Output = (Value, L0, L1);
}

impl<L0, L1, L2, Value> PushFront_<Value> for (L0, L1, L2) {
    type Output = (Value, L0, L1, L2);
}

impl<L0, L1, L2, L3, Value> PushFront_<Value> for (L0, L1, L2, L3) {
    type Output = (Value, L0, L1, L2, L3);
}

impl<L0, L1, L2, L3, L4, Value> PushFront_<Value> for (L0, L1, L2, L3, L4) {
    type Output = (Value, L0, L1, L2, L3, L4);
}

impl<L0, L1, L2, L3, L4, L5, Value> PushFront_<Value> for (L0, L1, L2, L3, L4, L5) {
    type Output = (Value, L0, L1, L2, L3, L4, L5);
}

impl<L0, L1, L2, L3, L4, L5, L6, Value> PushFront_<Value> for (L0, L1, L2, L3, L4, L5, L6) {
    type Output = (Value, L0, L1, L2, L3, L4, L5, L6);
}

impl<L0, L1, L2, L3, L4, L5, L6, L7, Value> PushFront_<Value> for (L0, L1, L2, L3, L4, L5, L6, L7) {
...
impl<L0> PopFront_ for (L0,) {
    type Output = Some_<(L0, ())>;
}

impl<L0, L1> PopFront_ for (L0, L1) {
    type Output = Some_<(L0, (L1,))>;
}

impl<L0, L1, L2> PopFront_ for (L0, L1, L2) {
    type Output = Some_<(L0, (L1, L2))>;
}

impl<L0, L1, L2, L3> PopFront_ for (L0, L1, L2, L3) {
    type Output = Some_<(L0, (L1, L2, L3))>;
}

impl<L0, L1, L2, L3, L4> PopFront_ for (L0, L1, L2, L3, L4) {
    type Output = Some_<(L0, (L1, L2, L3, L4))>;
}

impl<L0, L1, L2, L3, L4, L5> PopFront_ for (L0, L1, L2, L3, L4, L5) {
    type Output = Some_<(L0, (L1, L2, L3, L4, L5))>;
}

impl<L0, L1, L2, L3, L4, L5, L6> PopFront_ for (L0, L1, L2, L3, L4, L5, L6) {
    type Output = Some_<(L0, (L1, L2, L3, L4, L5, L6))>;
}

impl<L0, L1, L2, L3, L4, L5, L6, L7> PopFront_ for (L0, L1, L2, L3, L4, L5, L6, L7) {
    type Output = Some_<(L0, (L1, L2, L3, L4, L5, L6, L7))>;
}

impl<L0, L1, L2, L3, L4, L5, L6, L7, L8> PopFront_ for (L0, L1, L2, L3, L4, L5, L6, L7, L8) {
