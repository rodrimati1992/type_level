use crate_::collection_ops::{
    FoldL, FoldL_, FoldR, FoldR_, Len, Len_, Map, MapMt, Map_, PushOp, RepeatOp, TFBreak, TFVal,
    TryFoldL, TryFoldLMt, TryFoldL_, TryFoldR, TryFoldR_,
};
use crate_::fn_adaptors::*;
use crate_::ops::{
    Add1Op, AssertEq, ConstEq, ConstEqOp, ConstGEOp, ConstInto, ConstIntoMt, ConstInto_, ConstLEOp,
    ConstLtOp, ConstNEOp, ConstOrd_, If, IsZeroOp, SafeSubOp, SatSub1Op, SatSubOp, Sub1Op,
};
...
mod test_eq {
    ...
    #[test]
    fn len_() {
        type Test<Rang, Leng> = AssertEq<Len<Rang>, Leng>;
    ...
    #[test]
    fn into_list() {
        type Test<Rang, List> = AssertEq<ConstInto<Rang, TListType>, List>;
    ...
    #[test]
    fn fold() {
        type TestL<Rang, Val> = AssertEq<FoldL<Rang, TNil, PushOp>, Val>;
        type TestR<Rang, Val> = AssertEq<FoldR<Rang, TNil, PushOp>, Val>;
    ...
    fn try_fold() {
        ...
        type TestL<Rang, Initial, Val> = AssertEq<TryFoldL<Rang, Initial, TryIteration>, Val>;
        type TestR<Rang, Initial, Val> = AssertEq<TryFoldR<Rang, Initial, TryIteration>, Val>;
        ...
        let _: TestL<
            ConstRange<U0, U5>,
            (U10, TNil),
            TFVal<(U0, tlist![U0, U4, U7, U9, U10])>,
        >;
    ...
    #[test]
    fn map() {
        type TestA<Rang, Val> = AssertEq<Map<Rang, SubRevMt<U10>>, Val>;
