...
use std::{iter,slice,env, fmt, fs, io, path};
...
fn get_typename(s_or_e:StructOrEnum,c_or_r:ConstOrRunt,impls:EnabledImpl)->String{
...
{
    type Item=(StructOrEnum,EnabledImpl);
...
fn type_impls_permutations()->OrImpls<ImplProduct>{
...
")?;
    for (soe,impls) in type_impls_permutations() {
        let name=get_typename(soe,ConstOrRunt::Const,impls);
        let deriving_type=get_typename(soe,ConstOrRunt::Runt,impls);
        ...
        match (impls.contains(EnabledImpl::CONST_EQ ),soe) {
            ...
            (true ,StructOrEnum::Struct)=>{
                writeln!(w,"let _:TestEq<Val0,Val0,True>;")?;
                writeln!(w,"let _:TestEq<Val0,Val1,False>;")?;
                writeln!(w,"let _:TestEq<Val0,Val2,False>;")?;
                writeln!(w,"let _:TestEq<Val0,Val3,False>;")?;
                
                writeln!(w,"let _:TestEq<Val1,Val1,True>;")?;
                writeln!(w,"let _:TestEq<Val1,Val2,False>;")?;
                writeln!(w,"let _:TestEq<Val1,Val3,False>;")?;

                writeln!(w,"let _:TestEq<Val2,Val2,True>;")?;
                writeln!(w,"let _:TestEq<Val2,Val3,False>;")?;
                
                writeln!(w,"let _:TestEq<Val3,Val3,True>;")?;
            },
            (true ,StructOrEnum::Enum  )=>{
                writeln!(w,"let _:TestEq<Open0,Closed,False>;")?;
                writeln!(w,"let _:TestEq<Open1,Closed,False>;")?;
                writeln!(w,"let _:TestEq<Open2,Closed,False>;")?;
                
                writeln!(w,"let _:TestEq<Open0,Open0,True>;")?;
                writeln!(w,"let _:TestEq<Open0,Open1,False>;")?;
                writeln!(w,"let _:TestEq<Open0,Open2,False>;")?;
                writeln!(w,"let _:TestEq<Open1,Open1,True>;")?;
                writeln!(w,"let _:TestEq<Open1,Open2,False>;")?;
                writeln!(w,"let _:TestEq<Open2,Open2,True>;")?;
            },
        }
        ...
        match (impls.contains(EnabledImpl::CONST_ORD ),soe) {
            (false,_)=>{},
            (true,StructOrEnum::Struct)=>{
                writeln!(w,"let _:TestOrd<Val0,Val0,Equal_>;")?;
                writeln!(w,"let _:TestOrd<Val0,Val1,Less_>;")?;
                writeln!(w,"let _:TestOrd<Val0,Val2,Less_>;")?;
                writeln!(w,"let _:TestOrd<Val0,Val3,Less_>;")?;
                
                writeln!(w,"let _:TestOrd<Val1,Val1,Equal_>;")?;
                writeln!(w,"let _:TestOrd<Val1,Val2,Less_>;")?;
                writeln!(w,"let _:TestOrd<Val1,Val3,Less_>;")?;

                writeln!(w,"let _:TestOrd<Val2,Val2,Equal_>;")?;
                writeln!(w,"let _:TestOrd<Val2,Val3,Less_>;")?;
                
                writeln!(w,"let _:TestOrd<Val3,Val3,Equal_>;")?;
            },
            (true,StructOrEnum::Enum)=>{
                writeln!(w,"let _:TestOrd<Open0,Closed,Less_>;")?;
                writeln!(w,"let _:TestOrd<Open1,Closed,Less_>;")?;
                writeln!(w,"let _:TestOrd<Open2,Closed,Less_>;")?;
                
                writeln!(w,"let _:TestOrd<Open0,Open0,Equal_>;")?;
                writeln!(w,"let _:TestOrd<Open0,Open1,Less_>;")?;
                writeln!(w,"let _:TestOrd<Open0,Open2,Less_>;")?;
                writeln!(w,"let _:TestOrd<Open1,Open1,Equal_>;")?;
                writeln!(w,"let _:TestOrd<Open1,Open2,Less_>;")?;
                writeln!(w,"let _:TestOrd<Open2,Open2,Equal_>;")?;
...
let _:AssertEq<<Val1 as {deriving}Trait>::y , U10>;

let _:AssertEq<<Val1 as {deriving}WithRuntime<u32>>::rt_x , U0>;
let _:AssertEq<<Val1 as {deriving}WithRuntime<u32>>::rt_y , U10>;
...
let _:AssertEq<
    GetDiscrOf<Open0>,
    Discriminant<variants::Open_Variant,{consttype},U0>
>;
let _:AssertEq<
    GetDiscrOf<Open1>,
    Discriminant<variants::Open_Variant,{consttype},U0>
...
let _:AssertEq<
    GetDiscrOf<Closed>,
    Discriminant<variants::Closed_Variant,{consttype},U1>
>;
...
fn assert_closed()
where  Closed:ClosedTrait+ClosedWithRuntime
{{}}
...
fn type_decls<W:ioWrite>(mut w:W)->io::Result<()> {
    for (soe,impls) in type_impls_permutations() {
        let name=get_typename(soe,ConstOrRunt::Runt,impls);
        ...
        match soe {
            StructOrEnum::Struct=>{
                ...
                writeln!(w,"pub struct {name}<T> {{",name=name)?;
                writeln!(w,"    pub x:bool,")?;
                writeln!(w,"    pub y:Option<T>,")?;
                writeln!(w,"}}\n")?;
            }
            StructOrEnum::Enum=>{
                writeln!(w,"#[derive(Debug,PartialEq,Eq)]")?;
                writeln!(w,"pub enum {name} {{",name=name)?;
