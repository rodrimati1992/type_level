...
use super::{attribute_detection, Arenas, ArenasRef};

use data_structure::{DataStructure, EnumOrStruct, FieldIdent, Struct, StructKind};
...
use self::struct_declarations::StructDeclarations;
